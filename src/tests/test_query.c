...
test_main(void) {
    if (set_locale("en_US.UTF-8")) {
        QueryTest main_tests[] = {
            ...
            {"draft AND report", "draft-report.pdf", false, 0, 0, true},
            {"draft OR final", "final-report.pdf", false, 0, 0, true},
            {"NOT draft", "final-report.pdf", false, 0, 0, true},
            {"NOT draft", "draft-report.pdf", false, 0, 0, false},
            ...
            {"glob:file?.png", "file77.png", false, 0, 0, false},
            {"glob:[abc].png", "b.png", false, 0, 0, true},
            {"glob:[!abc].png", "d.png", false, 0, 0, true},
            {"glob:[!abc].png", "b.png", false, 0, 0, false},
            {"glob:[a-c].png", "b.png", false, 0, 0, true},
            {"glob:[a-c].png", "d.png", false, 0, 0, false},
            {"glob:file{.png,.jpg}", "file.jpg", false, 0, 0, true},
            {"glob:file{.png,.jpg}", "file.gif", false, 0, 0, false},
            {"glob:image{01..03}.png", "image02.png", false, 0, 0, true},
            {"glob:image{01..03}.png", "image04.png", false, 0, 0, false},
            {"case:glob:\"{AGENTS,CLAUDE}.md\"", "AGENTS.md", false, 0, 0, true},
            {"case:glob:\"{AGENTS,CLAUDE}.md\"", "agents.md", false, 0, 0, false},
            {"glob:\"\\*.png\"", "*.png", false, 0, 0, true},
            {"glob:\"\\*.png\"", "photo.png", false, 0, 0, false},
